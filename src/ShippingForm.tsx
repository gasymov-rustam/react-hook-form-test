...
const ShippingForm: FC = () => {
  ...
  console.log(getFieldState('confirmName'));
        ...
        <div>
          <input
            {...register('confirmName', {
              required: 'confirm your name is require field!',
              validate: {
                confirmValue: (value) => {
                  return value === getValues('name') || 'ERROR MESSAGE';
                },
              },
            })}
          ...
          />
          {errors?.confirmName && (
            <div style={{ color: 'red', marginBottom: 10 }}>{errors.confirmName.message}</div>
          )}
        </div>
